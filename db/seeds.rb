...
Cat.destroy_all
Cat.create(name: 'Gus', pic: 'gus.jpg', owner: 'Grimes Family',ct_jdgmts_cute: 0, ct_wins_cute: 0, ct_jdgmts_maj: 0,  ct_wins_maj:0)
Cat.create(name: 'Maru', pic:'assets/maru.jpg', owner: 'Internet',ct_jdgmts_cute: 0, ct_wins_cute: 0, ct_jdgmts_maj: 0,  ct_wins_maj:0)
